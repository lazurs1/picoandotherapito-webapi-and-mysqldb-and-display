...
while True:
    ...
    pushData="https://python.faith/dax/posttest.php?Devices=Novi_Server_Room_PI_Pico_W&Sensor_name=BMP280&Sensor_Humidity=" + str(dht11hum) + "&Sensor_Temp=" + str(tempfbmp280) + "&DateTime=12/27/2002&Sensor2_name=DHT22&Sensor2_Humidity=" + str(dht22hum) + "&Sensor2_Temp=" + str(dht22temp)
    #print(pushData)
